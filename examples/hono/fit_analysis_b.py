...
# ax.set_xlim(lims)
# ax.set_ylim(lims)
# plt.savefig("hono_hooi_val_corr.pdf", bbox_inches="tight", dpi=300)

plt.plot(e_ab_sorted, rms, rasterized=True)
plt.xlabel(r'$E_{ref} \, (cm^{-1})$')
plt.ylabel(r'RMSE $(cm^{-1})$')
plt.savefig("hono_hooi_reg.pdf", bbox_inches="tight", dpi=300)
